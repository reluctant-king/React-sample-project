      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {groceries.map((grocery) => (
          ...
          >
            ...
            />
            <h2 className="font-semibold text-lg">{grocery.name}</h2>
            <p className="text-gray-500">{grocery.brand}</p>
            <p className="font-bold mt-2">${grocery.price}</p>
            <p className="text-sm mt-1 text-gray-400">{grocery.category}</p>
          </div>
        ))}
      </div>
    </div>
